...
async function main() {
  ...
  console.log(
    `   Found ${lpRewardsMarkets.data.length} of ${lpRewardsMarkets.totalMarketsCount} markets\n`
  );
  ...
  console.log(`   Found ${highValueMarkets.data.length} markets\n`);
  ...
  console.log(
    `   Found ${defaultMarkets.data.length} of ${defaultMarkets.totalMarketsCount} markets\n`
  );
}
